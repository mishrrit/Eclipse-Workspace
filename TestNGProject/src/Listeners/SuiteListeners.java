...
public class SuiteListeners implements ITestListener, ISuiteListener, IInvokedMethodListener {
	...
	public void onFinish(ISuite arg0) {
		...
		System.out.println("#################################");
		System.out.println("##### Pass percentage is "+passedtests.size()*100/(passedtests.size()+failedtests.size()+skippedtests.size())+"% ####");
		System.out.println("#################################");
	}
	...
	/*private String returnPassPercentage(ISuiteResult result) {
	...
	private void onTestFailedButWithinSuccessPercentage1(ITestResult result) {
